...
sink(file.path(output_dir, "analysis_log.txt"))
...
# Save averaged data
write.csv(final_df, file.path(output_dir, "input_data_averaged.csv"), row.names = FALSE)

# Save processed data
write.csv(CTdf, file.path(output_dir, "data_processed.csv"), row.names = FALSE)
sink()
